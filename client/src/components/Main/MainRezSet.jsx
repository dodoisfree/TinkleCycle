      ...
      <div className="rezSetArea">
        <div className="rezSetGroup">
          <section className="dateSetBox">
            <h3 className="h3"><strong>날짜 선택</strong>{formik.errors.date ? (<span className="alert">{formik.errors.date}</span>) : null}</h3> 
        ...
        <div className="rezSetGroup">
          <section className="rezSetBox">
            <label htmlFor="bicCnt">
              <h3 className="h3"><strong>수량 선택</strong>{formik.errors.bicCnt ? (<span className="alert">{formik.errors.bicCnt}</span>) : null}</h3>
            </label>
          ...
          <section className="rezSetBox">
            <label htmlFor="time">
              <h3 className="h3"><strong>대여시간 선택</strong>{formik.errors.startTime ? (<span className="alert">{formik.errors.startTime}</span>) : null}</h3>
            </label>
            <div className="rezSet" >
